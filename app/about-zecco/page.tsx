            ...
            <section className="py-10 -mt-7 bg-white">
                <div className="lg:mx-10 px-6">
                    <div className="flex flex-col md:flex-row md:justify-between mb-7">
                        <div className="">
                            <p className='font-manrope font-medium text-[#000000] uppercase flex items-center gap-1 mb-5'> <div className='w-3 h-3 bg-[#747474] rounded-full'></div>About us</p>
                        ...
                        <div className="">
                            ...
                            <button onClick={handleNavigate} className="w-fit px-10 mt-10 tracking-wider shadow-md my-4 bg-[#136AED] text-white text-[15px] py-2.5 rounded-full font-inter font-semibold flex items-center gap-2">
                                Explore properties
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-7">
                        {[{ title: "Vetted Excellence", description: "Every listing is manually vetted for legal and financial integrity." },
                        { title: "Data Enlightenment", description: "Our neural networks help you find the highest yield investments." },
                        { title: "Human Connection", description: "A personal agent guides you through every single step of the purchase." }]?.map((item, i) => (
