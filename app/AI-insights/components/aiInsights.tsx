                ...
                <div className="bg-white/70 rounded-2xl relative">
                    <div className="lg:flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-1 max-md:mb-5">
                            <h2 className='font-bold text-lg font-manrope px-4 pt-4 text-[#64748B]'>€545,000</h2>
                            <h1 className="font-bold text-md font-inter px-4 pt-1 text-[#111827]">2-Bedroom Apartment in Marbella, Spain</h1>
