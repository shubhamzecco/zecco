...
export function MapSection() {
  return (
    <div className="mb-8">
      <h3 className="text-xl font-bold font-manrope text-heading_text_color mb-4">Explore The Neighborhood</h3>
      <div className="rounded-lg overflow-hidden bg-gradient-to-b from-blue-200 to-blue-100 h-80 relative">
        ...
        <MapPin className="w-4 h-4" />  Nearby Places <ChevronDown className="w-4 h-4" />
        </div>
      </div>
