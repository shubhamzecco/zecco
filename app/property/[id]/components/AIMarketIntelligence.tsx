  ...
  return (
    <div className="mb-8 bg-[#fafafa] border border-[#F3F4F6] rounded-xl p-6">
      <div className="flex items-center gap-2 mb-6">
        <h2 className="text-xl font-bold font-manrope">AI Market Intelligence</h2>
      ...
      <div className="bg-white p-6 rounded-xl mb-6">
        <div className="flex items-center justify-between">
          <h3 className="font-bold text-heading_text_color text-lg mb-4 font-manrope">Pricing Trajectory</h3>
          <p className='font-manrope font-medium text-[#9CA3AF] text-sm'>Avg. Price / m²</p>
        </div>
        <div className="h-48 flex items-end justify-between gap-2 px-4 mt-20">
          <PricingChart />
        </div>
      </div>
