...
export default function HeroSection() {
  return (
    <div className="relative  h-[115vh] w-full  bg-gradient-to-b from-sky-600/20  via-white to-white">
      {/* Background Image */}
      <Image
      ...
      {/* Center Content */}
      <div className="absolute inset-0 flex flex-col -mt-60 justify-center items-center text-center px-4">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl lg:text-[3.4rem] font-manrope font-bold text-heading_text_color mb-4 text-balance">
            Find Your Dream Home In{' '}
            <span className="bg-gradient-to-b from-[#1466EC] to-[#04ADF7] bg-clip-text text-transparent">Spain</span>
          </h1>
