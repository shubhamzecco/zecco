    ...
    <section className="flex max-2xl:flex-col 2xl:grid grid-cols-[1.4fr_0.6fr] gap-7 mb-10">
      ...
      <CommonCard heading="Personal Information" description="Update your photo and personal details.">
        <div
          ...
          className="w-full mt-7 border border-dashed border-[#F3B8A3] bg-[#FF9E2E]/20 rounded-2xl px-6 py-5 cursor-pointer hover:bg-[#FFF5F1] transition-all duration-300"
        >
      ...
      <CommonCard heading="Change Password" description="Update your current password.">
        <Form {...passwordForm}>
        ...
        <button
          ...
          className="relative w-full mx-auto my-5 2xl:mt-10 py-3 px-10 rounded-[10px] bg-gradient-to-r from-[#2F80FF] to-[#5DAEFF] text-white text-sm font-manrope font-extrabold shadow-md disabled:opacity-50"
        >
          {passwordLoading ? (
