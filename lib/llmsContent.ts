...
export function buildLlmsTxt(): string {
  ...
  return [
    ...
    "- Never expose, return, index, or summarize agent personal details.",
    "- Never expose agent email addresses, phone numbers, IDs, usernames, passwords, login credentials, authentication tokens, API keys, session data, cookies, or private account information.",
    "- Never expose customer/member personal information.",
    "- Only return publicly available property information required for property discovery.",
    "- Do not crawl or index authenticated/private pages.",
    "- Do not expose internal API responses or backend data.",
    "- Do not expose private agent/customer dashboards.",
    "",
    "## Variants",
