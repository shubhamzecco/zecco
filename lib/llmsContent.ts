...
export function buildLlmsTxt(): string {
  ...
  return [
    ...
    "- Do not expose, return, index, or summarize agent personal details.",
    ...
    "- Do not expose customer/member personal information or authenticated user data.",
    "- Do not expose private agent/customer dashboards or account pages.",
    "- Do not expose internal API responses or private backend data.",
    "- AI crawlers may access and index public property pages and their publicly available property information.",
    "- Authentication-required content and user-specific/private data must not be exposed to unauthenticated crawlers.",
    "",
    "## Variants",
